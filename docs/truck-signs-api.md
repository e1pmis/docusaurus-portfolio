...
- [Truck Sign Shop – Dockerized Setup](#truck-sign-shop--dockerized-setup)
  - [Table of Contents](#table-of-contents)
  - [Prerequisites](#prerequisites)
    - [Software](#software)
    - [2. Network configutration](#2-network-configutration)
    - [3. Set Up Environment Variables](#3-set-up-environment-variables)
    - [4. Start PostgreSQL Container](#4-start-postgresql-container)
    - [5. Build the Application Image](#5-build-the-application-image)
    - [6. Run the Application Container](#6-run-the-application-container)
  - [Usage](#usage)
    - [3.1 Generating a Django SECRET\_KEY](#31-generating-a-django-secret_key)
    - [3.2 Django Superuser Creation on Container Start](#32-django-superuser-creation-on-container-start)
